...
// Display the selected questions (you can handle them as needed)
console.log(quiz);
...
const api = "https://localhost:7248/api/Quiz/" + 150;
...
function getLeaderBoard() {
    ...
    $('#leaderboard').empty();
    const api = "https://localhost:7248/api/LeaderBoard/GetL";
...
function successCB1(data) {
    ...
    function login() {
        ...
        if (logged != null) {
            ...
            const api = "https://localhost:7248/api/Users/UserLogIn/" + $('#email4').val() + "/" + $('#password4').val();
    ...
    function endQuiz() {
        ...
        const api1 = "https://localhost:7248/api/LeaderBoard";
        $.ajax({
            type: "POST",
            url: api1,
