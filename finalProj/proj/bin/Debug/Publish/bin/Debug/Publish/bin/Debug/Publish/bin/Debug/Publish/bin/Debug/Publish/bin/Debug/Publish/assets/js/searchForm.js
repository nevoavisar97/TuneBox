$(document).ready(function () {
    ...
    function submitSearch() {
        ...
        if (category === 'artist') {
            const api = "https://localhost:7248/api/Song/SearchSongsByArtist/" + query;
            ajaxCall("GET", api, "", successCBa, errorCB);
        }

        else if (category === 'song') {
            const api = "https://localhost:7248/api/Song/SearchSongs/" + query;
    ...
    function submitSearch1() {
        ...
        if (category === 'artist') {
            const api = "https://localhost:7248/api/Song/SearchSongsByArtist/" + query1;
            ajaxCall("GET", api, "", successCBa, errorCB);
        }

        else if (category === 'song') {
            const api = "https://localhost:7248/api/Song/SearchSongs/" + query1;
            ajaxCall("GET", api, "", successCB, errorCB);
        }
        function errorCB(err) {
            alert("Connection to server failed");
